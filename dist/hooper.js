  ...
  var script = {
    ...
    methods: {
      ...
      initEvents: function initEvents() {
        this.removeEvents(); // get the element direction if not explicitly set
    ...
    watch: {
      mouseDrag: function mouseDrag(value) {
        this.initDefaults();
        this.initEvents();
      },
      touchDrag: function touchDrag(value) {
        this.initDefaults();
        this.initEvents();
      },
      wheelControl: function wheelControl(value) {
        this.initDefaults();
        this.initEvents();
      },
      keysControl: function keysControl(value) {
        this.initDefaults();
        this.initEvents();
      },
      settings: function settings(value) {
        this.initDefaults();
        this.initEvents();
      }
    }
